...
PACKAGE_NAME = 'djangocms-association'
PACKAGE_DOWNLOAD_URL = 'https://github.com/python-spain/djangocms-association/archive/master.zip'  # .tar.gz
URL = 'https://github.com/python-spain/djangocms-association'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['djangocms', 'association', 'djangocms-association', 'djangocms-contact', 'djangocms-event',
            'djangocms-event', 'djangocms-people', 'contact', 'event', 'people']  # Palabras
# clave
...
DESCRIPTION = """\
Modules for building partnerships in Django CMS.
"""
...
PYTHON_VERSIONS = ['3.3-3.5']  # or ranges: 3.1-3.5, 2.6-3.4...
INSTALL_REQUIRES = []  # Necesario si no hay un requirements.txt
DEFAULT_MODULE = 'cms_association'
...
if os.path.exists(version_path):
    ...
    package_version = __import__(DEFAULT_MODULE or modules[0]).__version__
